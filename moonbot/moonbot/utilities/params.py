...
L1 = 1 # Length between joint1 (Near the base joint) and joint2
L2 = 1 # Length between joint2 and joint3 (Near the Tip Joint)
L3 = 1 # Length between Joint3 and Tip
D1 = 1 # Distance between Origin of base and origin of the joint1
