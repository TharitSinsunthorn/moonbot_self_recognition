...
class Metaclass_GetPosition_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('dynamixel_custom_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dynamixel_custom_interfaces.srv.GetPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dynamixel_custom_interfaces.srv import _get_position
...
class GetPosition(metaclass=Metaclass_GetPosition):
    from dynamixel_custom_interfaces.srv._get_position import GetPosition_Request as Request
    from dynamixel_custom_interfaces.srv._get_position import GetPosition_Response as Response
