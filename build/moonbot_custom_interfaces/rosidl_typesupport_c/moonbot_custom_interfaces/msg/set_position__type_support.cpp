...
static const _SetPosition_type_support_symbol_names_t _SetPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moonbot_custom_interfaces, msg, SetPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moonbot_custom_interfaces, msg, SetPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moonbot_custom_interfaces, msg, SetPosition)() {
  return &::moonbot_custom_interfaces::msg::rosidl_typesupport_c::SetPosition_message_type_support_handle;
}
