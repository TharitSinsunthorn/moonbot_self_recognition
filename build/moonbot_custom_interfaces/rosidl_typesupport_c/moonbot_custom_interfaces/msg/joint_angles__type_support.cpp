...
static const _JointAngles_type_support_symbol_names_t _JointAngles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moonbot_custom_interfaces, msg, JointAngles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moonbot_custom_interfaces, msg, JointAngles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moonbot_custom_interfaces, msg, JointAngles)() {
  return &::moonbot_custom_interfaces::msg::rosidl_typesupport_c::JointAngles_message_type_support_handle;
}
