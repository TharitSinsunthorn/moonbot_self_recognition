...
#include "moonbot_custom_interfaces/msg/detail/set_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const moonbot_custom_interfaces::msg::SetPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moonbot_custom_interfaces::msg::SetPosition & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const moonbot_custom_interfaces::msg::SetPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moonbot_custom_interfaces::msg::SetPosition *>(
    untyped_ros_message);
...
{
  return &moonbot_custom_interfaces::msg::typesupport_fastrtps_cpp::_SetPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moonbot_custom_interfaces, msg, SetPosition)() {
  return &moonbot_custom_interfaces::msg::typesupport_fastrtps_cpp::_SetPosition__handle;
}
